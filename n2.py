...
---------------------------------------------
\033[1;96m|-------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-----|
\033[1;96m|               NAEEMN2M Technology Channel              |
\033[1;96m|This Tool is Only for Bangladesh FB Acounts|
\033[1;96m|------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+------|

\033[1;91m [⚡\033[1;97mAuthor Name: NAEEM KHAN     ⚡\033[1;91m]
\033[1;91m [⚡\033[1;97mYutube Channel: naeemn2m Technology ⚡\033[1;91m]
\033[1;91m [⚡       \033[1;97mWhatsApp: 01860350021  ⚡\033[1;91m]
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mABIRYT\033[1;95m-_-_-_-_-_-_-_-_-»
"""
...
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mNAEEM\033[1;95m-_-_-_-_-_-_-_-_-»
 """
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #NAEEM
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;93mWrong Password"
            os.system('xdg-open https://www.facebook.com/c/mdnaeem.n2m')
    else:
        print "\033[1;94mWrong Username"
        os.system('https://www.facebook.com/mdnaeem.n2m')
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://youtube.com/c/NAEEMTechnologychannel')
...
def menu():
	...
	print "\033[1;97m[3]\x1b[1;92mSubscribe naeemn2m Technology Youtube Channel " 
...
def pilih():
	...
	if unikers =="":
		...
		os.system('xdg-open https://youtube.com/c/naeemn2m')
	        menu()		
	elif unikers =="0":
		jalan('Token Removed')
		os.system('rm -rf login.txt')
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mNaeemYT\033[1;95m-_-_-_-_-_-_-_-_-»"
		print logo
	...
	p.map(main, id)
#NAEEM KHAN
        print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mNAEEM Islam\033[1;95m-_-_-_-_-_-_-_-_-»"
...
print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mNAEEM\033[1;95m-_-_-_-_-_-_-_-_-»"
